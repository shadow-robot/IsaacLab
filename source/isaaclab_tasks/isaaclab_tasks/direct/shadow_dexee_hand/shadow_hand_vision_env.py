...
class ShadowHandVisionEnvCfg(ShadowHandEnvCfg):
    ...
    tiled_camera: TiledCameraCfg = TiledCameraCfg(
        ...
        offset=TiledCameraCfg.OffsetCfg(pos=(-0.07, 0.0, 1.14), rot=(0.7960838, 0.0, 0.6051864, 0.0), convention="world"),
    ...
    state_space = 117 + 27  # asymettric states + vision CNN embedding
